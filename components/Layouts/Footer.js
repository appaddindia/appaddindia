                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="footer-area">
                                    ...
                                    <p>Appadd India Pvt Ltd. was established in the year 2016, is proudly among one of those digital and software solution provider whose ideology totally matches with the evolving needs of the digital world. The company started operating with the vision to give their clients a very unique experience of their vast potential.</p>

                                    <ul className="footer-social">
                                        <li>
                                            <a href="https://www.linkedin.com/company/appadd-india-pvt-ltd/" target="_blank" className="bg-3955bc">
                                                <i className="fab fa-linkedin-in"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.facebook.com/appaddindia/" target="_blank" className="bg-1da1f2">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="mb-30">
                                    ...
                                    <div className="footer-info-contact">
                                        ...
                                        <h3>Address</h3>
                                        <span>#1697/36, Ground floor, Golden House, Dr. Rajkumar Road, Rajajinagar, Bangalore - 560021</span>
                                    </div>
                                </div>
                            </div>
                        </div>
