...
const CareersForm = () => {
    ...
    const handleSubmit = async e => {
        e.preventDefault();
        try {
            const url = `https://appaddindia.com/careers.php`;
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-6">
                        <div className="contact-text">
                            <h3>Get in Touch</h3>
                            <p>Have fun with the people at AppAdd. Learning and living your true potential at a company that encourages growth and ideas!</p>
